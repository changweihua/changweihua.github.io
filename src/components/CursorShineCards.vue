...
@keyframes svg-stroke-animation {
  ...
  100% {
    filter:
      drop-shadow(0 0 1px var(--color-1, oklch(0.82 0.08 285))) drop-shadow(0 0 2px var(--color-2,oklch(0.85 0.08 300)));
  }

  33% {
    filter:
      drop-shadow(0 0 2px var(--color-4,oklch(0.85 0.1 350))) drop-shadow(0 0 3px var(--color-3,oklch(0.86 0.09 340)));
  }

  66% {
    filter:
      drop-shadow(0 0 2px var(--color-8,oklch(0.85 0.07 240))) drop-shadow(0 0 3px var(--color-7,oklch(0.88 0.05 220)));
  }
}
</style>
