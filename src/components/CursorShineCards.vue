          ...
          <div class="card-info w-full flex flex-col justify-center">
            ...
            >
              <p class="description flex flex-col gap-3">
                <span
                  class="title"
                  v-html="DOMPurify.sanitize(`${marked.parseInline(item.title)}`)"
                ></span
...
<style lang="scss" scoped>
  .cards-container {
    ...
    .svg-stroke-animation.is-svg:hover {
      filter: drop-shadow(0 0 2px rgba(231, 76, 60, 0.8))
        drop-shadow(0 0 3px rgba(52, 152, 219, 0.8)) drop-shadow(0 0 4px rgba(46, 204, 113, 0.8));
    }
  }
  ...
  .svg-image::after {
    ...
    box-shadow:
      ...
      0 0 0 0px rgba(231, 76, 60, 0),
      0 0 0 0px rgba(46, 204, 113, 0);
...
<style scoped>
  ...
  @keyframes svg-stroke-animation {
    0%,
    100% {
      filter: drop-shadow(0 0 1px var(--color-1, oklch(0.82 0.08 285)))
        drop-shadow(0 0 2px var(--color-2, oklch(0.85 0.08 300)));
    }

    33% {
      filter: drop-shadow(0 0 2px var(--color-4, oklch(0.85 0.1 350)))
        drop-shadow(0 0 3px var(--color-3, oklch(0.86 0.09 340)));
    }

    66% {
      filter: drop-shadow(0 0 2px var(--color-8, oklch(0.85 0.07 240)))
        drop-shadow(0 0 3px var(--color-7, oklch(0.88 0.05 220)));
    }
  }
</style>
