...
features:
  - title: 随身携带行李限额自助查询
    ...
    link: /en-US/gallery/baggage_measurer
  - title: 阳光服务平台
    icon:
      src: /sunnyland.svg
      alt: 阳光服务平台
    details: 依托微信小程序，为无锡硕放机场量身打造阳光服务平台
    link: /en-US/gallery/sunny-land
    # linkText: 更多详情
  - title: 无锡硕放机场旅客服务平台
    icon:
      src: /air_wux.png
    ...
    link: /en-US/gallery/airwux
  - title: 基于Yolo的对象检测、识别与研究
    icon:
      src: /yolo.svg
      alt: Yolo
    details: 支持Yolo8、9、10三大版本
    link: /en-US/gallery/yolo_object_dection
    # linkText: 更多详情
  # - title: 新生产统计APP
  #   details: H5 微应用平台。
  #   link: /gallery/maui
