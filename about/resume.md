...
> 目前就职于 *`上海民航华东凯亚江苏分公司`* ，担任 **[高级开发经理]** 职务，主要面向 `苏南硕放国际机场` 提供民航体系应用服务保障及项目开发和管理工作。
>

> 曾就职于国内知名外包公司，服务过 `星巴克`、`尼尔森`、`西门子`、`雅培`、`罗氏`、`康宝莱`等公司。
>

> 搭建了一套含小程序、网页端、移动端的跨平台和终端体系。体系核心架构包含`DOTNET`服务端跨平台，`Flutter`移动端跨平台，`Ant Design`和`Tencent Design`网页端和小程序端融合统一。
>

> 积极参加开源社区，目前加入了 unFIX 中文社区官网开发项目组。
>
