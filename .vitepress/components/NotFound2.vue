<template>
  ...
  <div>
    <svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0"
      y="0" width="320px" height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
      ...
      <g id="head" class="up">
		...
		C75.85,13.604,65.745,3.39,53.972,3.39">
            <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1"
              begin="0s" dur="0.75s" repeatCount="indefinite" values="
          ...
          <ellipse fill="#ccc" cx="55.021" cy="3.39" rx="3.344" ry="3.391">
            <animate dur="0.75s" attributeName="cy" calcMode="spline"
              keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s" values="
                           3.39;
                           12;
                           0;
                           3.39
		...
		C84.15,13.604,94.255,3.39,106.028,3.39">
            <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1"
              begin="0s" dur="0.6s" repeatCount="indefinite" values="
        ...
        <g>
          <g id="eyeLeft">
            <path fill="#FFFFFF" d="M72.116,47.955c0,5.443-4.045,9.853-9.033,9.853h-1.971c-4.988,0-9.032-4.41-9.032-9.853
              ...
              <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s"
                dur="0.8s" repeatCount="indefinite" values="
		...
		C102.547,67.282,103.383,68.4,103.383,69.778z">
          <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1"
            begin="0s" dur="1s" repeatCount="indefinite" values="
