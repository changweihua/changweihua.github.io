...
commentabled: true
recommended: true
title: ASP.NET Core 外部依赖调用治理实战
description: HttpClientFactory、Polly 与幂等边界
date: 2026-04-03 09:29:00 
...
## 示例代码：从无边界调用到可恢复的稳定调用 ##

### 问题写法：每次 new HttpClient + 无条件重试 ###
...
### 优化写法：Typed Client + Resilience Pipeline ###
