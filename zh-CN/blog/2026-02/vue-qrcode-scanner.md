...
在前端项目里做二维码识别，经常会遇到“背景复杂识别难”“二维码很小识别率低”“识别慢”的痛点。

本文给大家介绍一个基于 Vue 3 的二维码识别工具库 —— `vue-qrcode-scanner`，主打“识别稳、速度快、接入简单”。
...
```sh
npm install install vue-qrcode-scanner // [!=npm auto]
```

识别二维码需要 `jsQR` 算法库，请一并安装：

```sh
npm install install jsqr // [!=npm auto]
```
